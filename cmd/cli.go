...
import (
	...
	"github.com/statping-next/statping-next/handlers"
	"github.com/statping-next/statping-next/source"
	"github.com/statping-next/statping-next/types/configs"
	"github.com/statping-next/statping-next/types/core"
...
func updateDisplay() error {
	...
	if err != nil {
		return errors.Wrap(err, "Issue connecting to https://github.com/statping-next/statping-next")
	}
...
func checkGithubUpdates() (githubResponse, error) {
	url := "https://api.github.com/repos/statping-next/statping-next/releases/latest"
