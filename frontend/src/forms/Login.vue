<template>
    ...
    <form @submit.prevent="login" autocomplete="on">
        <div class="form-group row">
            ...
            <div class="col-8">
                <input @keyup="checkForm" @change="checkForm" type="text" v-model="username" autocomplete="username" name="username" class="form-control" id="username" :placeholder="$t('admin_placeholder')" autocorrect="off" autocapitalize="none">
            </div>
        </div>
        <div class="form-group row">
            <label for="password" class="col-4 col-form-label">{{$t('password')}}</label>
            <div class="col-8">
                <input @keyup="checkForm" @change="checkForm" type="password" v-model="password" autocomplete="current-password" name="password" class="form-control" id="password" :placeholder="$t('password_mask_placeholder')">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12">
