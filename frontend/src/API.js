...
class Api {
  constructor() {
    this.version = "0.91.0";
    this.commit = "3567754189f53ef9c946d054aacae4e070190868";
  }
  ...
  async incidents_archived() {
    return axios.get('api/incidents/archived').then(response => (response.data))
  }
  ...
  async incident_create_global(data) {
    return axios.post('api/incidents', { ...data, service: 0 }).then(response => (response.data))
  }
  ...
  async incident_update(incident, data) {
    return axios.post('api/incidents/' + incident.id, data).then(response => (response.data))
  }

  async incident_archive(incident, archived) {
    return axios.post('api/incidents/' + incident.id + '/archive', { archived }).then(response => (response.data))
  }
