...
<div class="row mb-4">
	...
	<div class="col">
	<h4 class="h4 mb-2">Original Fork Statping</h4>
	...
	<div class="col">
	<h4 class="h4 mb-2">Original Fork Badges</h4>
...
<div class="col-12" v-if='tab === "Home"'>
	<div v-pre>
		<h1>Statping NEXT - Status Page &amp; Monitoring Server</h1>

<p><img src="https://raw.githubusercontent.com/statping-next/statping-next/master/frontend/public/img/default-logo.svg" alt="Logo Image" /></p>

<p>Statping NEXT is a drop-in replacement for <a href="https://github.com/statping-ng/statping-ng" target="_blank">statping-ng</a>. It was concieved after the author desired several changes to the project, that were likely not ever to be implemented, both due to their opinionated nature and due to a seeming stall in that project&rsquo;s development.</p>

<p>We provide no precompiled images at this time. Use the <code>Makefile</code> to reference how to build Statping NEXT, or use <code>make binary</code> for a Linux binary compatible with your current architecture.</p>

<p>The remainder of this Wiki is provided for posterity and is a direct clone of the original statping-ng wiki with no other changes. You may find some contents helpful for advanced usage, but most of it is obsolete.</p>
...
<p><strong>This section is out of date</strong></p>
...
&gt;&gt; 1
	...
	<div class="col-12" v-if='tab === "Docker"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>Statping is easily ran on Docker with the light weight Alpine linux image. View on <a href="https://hub.docker.com/r/adamboutcher/statping-ng" target="_blank">Docker Hub</a> or <a href="https://quay.io/repository/statping-ng/statping-ng" target="_blank">quay.io</a></p>

<p align="center">
<img alt="Docker Image Version" src="https://img.shields.io/docker/v/adamboutcher/statping-ng/latest?style=flat-square&color=success" />
<img alt="Docker Image Size" src="https://img.shields.io/docker/image-size/adamboutcher/statping-ng/latest?style=flat-square&color=success" />
<img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/adamboutcher/statping-ng?style=flat-square&color=success&logo=docker&logoColor=white" />
<img alt="Quay Container" src="https://quay.io/repository/statping-ng/statping-ng/status" />
</p>
...
<h1>Docker or Quay.io</h1>

<p>Whether you want to use DockerHub or Quay.io, we have an image. Simply change <code>adamboutcher/statping-ng</code> for <code>quay.io/statping-ng/statping-ng</code> if you&rsquo;d prefer to use Quay.io, all the examples and docker files use dockerhub by default.</p>
...
<pre><code class="language-bash">docker run -d -p 8080:8080 adamboutcher/statping-ng:dev
</code></pre>
...
<pre><code class="language-bash">docker run -it -p 8080:8080 adamboutcher/statping-ng:cypress
</code></pre>
...
<pre><code class="language-bash">wget https://raw.githubusercontent.com/statping-ng/statping-ng/master/servers/docker-compose.yml
docker-compose up -d
</code></pre>
...
<pre><code class="language-bash">wget https://raw.githubusercontent.com/statping-ng/statping-ng/master/servers/docker-compose-ssl.yml
...
<p align="center">
<img alt="Docker Image Version (tag latest semver)" src="https://img.shields.io/docker/v/adamboutcher/statping-ng/latest"> 
<img alt="Docker Image Size (tag)" src="https://img.shields.io/docker/image-size/adamboutcher/statping-ng/latest?label=:latest&color=green"> <img alt="Docker Image Size (tag)" src="https://img.shields.io/docker/image-size/adamboutcher/statping-ng/base?label=:base"> <img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/adamboutcher/statping-ng">
</p>
...
<pre><code class="language-shell">curl -o- -L https://raw.githubusercontent.com/statping-ng/statping-ng/stable/install.sh | bash
</code></pre>
...
<p>If you are using <a href="https://snapcraft.io/statping-ng" target="_blank">snap</a>, you can simply run this command to install Statping.</p>

<pre><code class="language-shell">sudo snap install statping-ng
</code></pre>

<p><a href="https://snapcraft.io/statping-ng">
<img alt="statping-ng" src="https://snapcraft.io/statping-ng/badge.svg" />
</a></p>
...
<p><strong>Note:</strong> Installing statping-ng via Snap no longer requires a manual service installation, you should be able to do <code>snap start statping-ng</code>.</p>
...
<h6>/etc/systemd/system/statping-ng.service</h6>
...
<p>Your Statping server will now automatically restart when your server restarts.</p>
...
<p>The Docker image is using the Statping Alpine binary since it&rsquo;s so incredibly small. You can run it on your own alpine image by downloading <code>statping-linux-alpine.tar.gz</code> from <a href="https://github.com/statping-ng/statping-ng/releases/latest" target="_blank">Latest Releases</a>. - This is currently unsupported.</p>
...
<img src="https://img.cjx.io/statping_iphone_bk.png">
	...
	<div class="col-12" v-if='tab === "Paid Hosting"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>Statping-ng does not provide any paid hosting.</p>
...
<div class="col-12 shadow-md mt-5">
	<div class="text-dim" v-pre>
		<p align="center">
<a href="https://statping-ng.github.io">Statping-ng</a> | <a href="https://demo.statping.com">Demo</a> | <a href="https://hub.docker.com/r/adamboutcher/statping-ng">Docker</a> | <a href="https://github.com/statping-ng/statping-ng/wiki/Notifiers">Notifiers</a>
</p>
...
Automatically generated from Statping's Wiki on 2026-02-01 17:45:29.122615209 &#43;0000 UTC
</div>
