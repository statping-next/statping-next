            ...
            <div class="col-md-3 col-sm-12 mb-4 mb-md-0">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  ...
                  <a @click.prevent="changeTab" class="nav-link" v-bind:class="{active: liClass('v-pills-configs-tab')}" id="v-pills-configs-tab" data-toggle="pill" href="#v-pills-configs-tab" role="tab" aria-controls="v-pills-configs-tab" aria-selected="false">
                    ...
                    <a href="https://github.com/statping-next/statping-next/wiki/API" class="mb-2 font-2 text-decoration-none text-muted">
                        <font-awesome-icon icon="laptop" class="mr-2"/> API {{$t('docs')}}
                    </a>

                    <a href="https://raw.githubusercontent.com/statping-next/statping-next/stable/CHANGELOG.md" class="mb-2 font-2 text-decoration-none text-muted">
                        <font-awesome-icon icon="book" class="mr-3"/> {{$t('changelog')}}
                    </a>

                    <a href="https://github.com/statping-next/statping-next" class="mb-2 font-2 text-decoration-none text-muted">
                        <font-awesome-icon icon="code-branch" class="mr-3"/> {{$t('repo')}}
                    </a>

                  <span class="small text-dim text-center mt-5">Statping NEXT {{core.version}}<br>
                    <a class="small text-muted no-decoration" v-if="core.commit" v-bind:href="`https://github.com/statping-next/statping-next/commit/${core.commit}`">{{core.commit.slice(0,8)}}</a>
                  </span>
